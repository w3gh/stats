...
CREATE TABLE IF NOT EXISTS `dotagames` (
  ...
  KEY `gameid` (`gameid`),
  KEY `winner` (`winner`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4095 ;
...
CREATE TABLE IF NOT EXISTS `dotaplayers` (
  ...
  KEY `item5` (`item5`),
  KEY `item6` (`item6`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=34906 ;
...
CREATE TABLE IF NOT EXISTS `gameplayers` (
  ...
  KEY `colour` (`colour`),
  KEY `name` (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1  AUTO_INCREMENT=40403 ;
