<?php /* source file: /home/jilizart/www/Yii/html/protected/modules/ghpp/views/games/view.php */ ?>
<?php
$scourge=true;
$sentinel=true;
$winner=0;
...
<div class="gamestat">
  <div class="grid_3 gamename"><?php /* line 9 */ echo Yii::t('ghppModule.game', 'Game: <b>{game}</b>', array('{game}'=>$model->gamename)); ?></div>
  <div class="grid_3 datetime"><?php /* line 10 */ echo Yii::t('ghppModule.game', 'Date: <b>{date}</b>', array('{date}'=>$model->date)); ?></div>
  <div class="grid_3 creatorname"><?php /* line 11 */ echo Yii::t('ghppModule.game', 'Creator: <b>{creator}</b>', array('{creator}'=>$model->creatorname)); ?></div>
  <div class="grid_3 duration"><?php /* line 12 */ echo Yii::t('ghppModule.game', 'Duration: <b>{duration}</b>', array('{duration}'=>GHtml::secondsToTime($model->duration))); ?></div>
  <div class="grid_4 servername"><?php /* line 13 */ echo Yii::t('ghppModule.game', 'On Server: <b>{server}</b>', array('{server}'=>$model->servername)); ?></div>
  <div class="clear"></div>
</div>
