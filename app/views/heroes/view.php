...
$hid=             CHtml::encode(strtoupper($hero["original"]));
$summary=         CHtml::encode($hero["summary"]);
$stats=           $hero["stats"];
$skills=          $hero["skills"];
...
<table>
	<tr>
		<td class='tableB'>
			<b><?=$description?></b> <?=__('app','Information')?>
		</td>
	</tr>
</table>
...
<div align='center'>
	<table class="tableHeroPageTop">
		<tr>
			<td width='68%' valign='top' class="tableHeroPageTopCell">
