...
<table>
	<tr>
		<th><?= __('app', 'Total Games: :total', array(':total' => $totalGames))?></th>
		<th><?=__('app', 'Average Duration: :duration', array(':duration' => $avgDuration))?></th>
		<th><?=__('app', 'Total Duration :duration', array(':duration' => $totalDuration))?></th>
	</tr>
</table>
